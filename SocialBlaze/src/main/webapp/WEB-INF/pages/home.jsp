...
<head>
	...
	.hero-section {
	    position: relative;
	    background-image: url('${pageContext.request.contextPath}/resources/hero-bg.jpg');
...
<body>
    ...
    <!-- Hero Section -->
        <div class="hero-section">
		    ...
		    <a href="${pageContext.request.contextPath}/login" class="get-started-btn">Get Started</a>
		</div>
   ...
   <!-- Why Choose Us Section -->
    ...
    <section class="about-us">
        <div class="about-img">
            <img src="${pageContext.request.contextPath}/resources/about.jpg" alt="About Us">
        </div>
